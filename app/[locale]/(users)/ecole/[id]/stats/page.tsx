// app/[locale]/(users)/ecole/[id]/stats/page.tsx
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      <main className="flex-1 p-6">
          ...
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="bg-white shadow-sm rounded-lg p-6">
                <CardContent>
                  <h3 className="text-xl font-semibold mb-4">Nombre d'Étudiants</h3>
                  <p className="text-2xl font-bold">{studentsCount}</p>
                </CardContent>
              </Card>
              <Card className="bg-white shadow-sm rounded-lg p-6">
                <CardContent>
                  <h3 className="text-xl font-semibold mb-4">Nombre de Commerciaux Associés</h3>
                  <p className="text-2xl font-bold">{commercialsCount}</p>
                </CardContent>
              </Card>
            </div>
          </CardContent>
        ...
        <Card className="w-full bg-white shadow-xl rounded-lg flex flex-col mb-6">
          <CardContent className="p-6">
            <h3 className="text-xl font-semibold mb-4">Répartition des Étudiants par Type de Permis</h3>
            <Pie data={licenseData} options={{ responsive: true, plugins: { legend: { position: 'top' }, title: { display: true, text: 'Étudiants par Type de Permis' } } }} />
          </CardContent>
        </Card>
      </main>
    </div>
